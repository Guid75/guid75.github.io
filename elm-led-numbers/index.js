			...
			var renderPartNum = F2(
				function (num, output) {
					...
					var content = A3(
						partRenderer,
						size,
						_elm_lang$core$Native_Utils.eq(size, index),
						numDisp);
					return A2(_elm_lang$core$Basics_ops['++'], output, content);
				});
			var content = A3(_elm_lang$core$List$foldl, renderPartNum, '', numbers);
			return A2(
