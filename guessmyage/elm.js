...
var _user$project$GuessMyAge$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$GuessMyAge$start = F2(
	function (age, model) {
...
var _user$project$GuessMyAge$updateYoungerThan = F2(
	function (age, model) {
		var youngerThan = A2(_elm_lang$core$Maybe$withDefault, _user$project$GuessMyAge$higherLimit + 1, model.youngerThan);
		return ((_elm_lang$core$Native_Utils.cmp(age, youngerThan) < 0) && (_elm_lang$core$Native_Utils.cmp(age, model.age) > -1)) ? _elm_lang$core$Maybe$Just(age) : model.youngerThan;
	});
var _user$project$GuessMyAge$lowerLimit = 1;
var _user$project$GuessMyAge$updateOlderThan = F2(
	function (age, model) {
...
var _user$project$GuessMyAge$ChangeEntryAge = function (a) {
	return {ctor: 'ChangeEntryAge', _0: a};
};
var _user$project$GuessMyAge$Submit = {ctor: 'Submit'};
var _user$project$GuessMyAge$StartGame = function (a) {
	return {ctor: 'StartGame', _0: a};
};
var _user$project$GuessMyAge$launchGame = A2(
	_elm_lang$core$Random$generate,
	_user$project$GuessMyAge$StartGame,
	A2(_elm_lang$core$Random$int, _user$project$GuessMyAge$lowerLimit, _user$project$GuessMyAge$higherLimit));
var _user$project$GuessMyAge$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						{ctor: '_Tuple2', _0: 'success', _1: success},
						{
						ctor: '_Tuple2',
						_0: 'failure',
						_1: finished && _elm_lang$core$Basics$not(success)
					}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Guess my age (in years)',
							A2(
								_elm_lang$core$Basics_ops['++'],
								', you still have ',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(model.remainingAttempts),
									' attempts'))))
					])),
				A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$id('entry'),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$GuessMyAge$Submit),
								_elm_lang$html$Html_Attributes$disabled(finished)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Age must be an integer between 1 and 100')
							])) : _elm_lang$html$Html$text('')
					])),
				forgeTip,
				A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onClick(_user$project$GuessMyAge$LaunchGame)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['GuessMyAge'], 'GuessMyAge', typeof _user$project$GuessMyAge$main === 'undefined' ? null : _user$project$GuessMyAge$main);
